#!/usr/bin/env python3
"""
patch_pdf_ameliore.py
Améliore pdf_report.py :
- En-tête professionnel avec bande colorée et logo textuel
- Numérotation des pages
- Section ACMG / Classification
- Section Populations africaines
- Meilleure mise en page générale
- Filigrane confidentiel

Exécuter depuis SenGenoScope/ :
  python3 patch_pdf_ameliore.py
"""

NEW_PDF = '''from reportlab.lib.pagesizes import A4
...
with open('pdf_report.py', 'w') as f:
    f.write(NEW_PDF)
...
checks = {
    'SGSDocTemplate': 'SGSDocTemplate' in content,
    'Filigrane CONFIDENTIEL': 'CONFIDENTIEL' in content,
    'Numéro de page': 'doc.page' in content,
    'Cartes statistiques': 'stat_cells' in content,
    'Section Afrique': 'africaines' in content,
    'Avertissement': 'Avertissement' in content,
}
print("VÉRIFICATIONS :")
...
print("  git add pdf_report.py")
print('  git commit -m "feat: PDF amélioré avec logo, filigrane, stats et section africaine"')
